...
export default {
	...
	errors: {
		...
		terminus_name_not_exists_on_blockchain: 'Terminus Name does not exist',
		...
		you_are_not_logged_in_terminus_space_yet_click_here_to:
			'You are not logged in to Terminus Space yet. Click here to',
	...
	you_are_not_logged_in_terminus_space_yet:
		'You are not logged in to Terminus Space yet',
	...
	please_authorize_and_verify_on_the_termipass_mobile_phone_to_bind_your_nft_avatar:
		'Please authorize and verify on TermiPass app to bind your NFT avatar',
	nft_images: 'NFT images',
	no_nft_available: 'No NFT available',
	select_the_image_to_complete_binding_nft_message:
		"Select the image and click 'Bind' to link the NFT avatar with your Terminus Name. After binding, you can view and set your NFT avatar from the NFT avatar list in the Profile app.",
	bound: 'Bind',
	accounts: 'Accounts',
	...
	only_after_binding_the_terminus_name_can_you_continue_to_bind_avatar_message:
		'You must bind Terminus Name before you can bind the blockchain wallet and obtain the NFT avatar',
	...
	login_and_bind_your_terminus_space_account:
		'Log in and bind your Terminus Space account',
	account: 'Account',
	password: 'Password',
	...
	login: {
		...
		novice_users_download_install_termipass:
			'Get started by installing the TermiPass app on your mobile device. After installation, scan the QR code with TermiPass app to log in. Learn more',
	...
	please_log_in_to_Terminus_Space_before_using_the_backup_service:
		'You must log in to your Terminus Space to use the backup service',
