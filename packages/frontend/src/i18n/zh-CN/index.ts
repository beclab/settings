...
export default {
	...
	errors: {
		...
		host_is_empty: '主机名是空的',
		host_is_error: '输入有效主机名',
		host_is_error_duplicate: '该主机名已被使用',
		ip_is_error: '输入有效IP地址'
	},
	pictures: '图片',
	...
	add_hosts: '添加主机',
	save_change: '保存更改',
	change_host_to_save: '主机文件的更改已准备好保存。是否继续？',
	ip: 'IP',
	get_logs: '收集日志',
	collect_failed_reason: '日志收集失败原因',
	querying_system_status: '正在查询系统状态',
	collect: '收集',
	collecting: '正在收集',
